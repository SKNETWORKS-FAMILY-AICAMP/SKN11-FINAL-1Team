...
urlpatterns = [
    ...
    path('add_template/<int:curriculum_id>/', views.add_template, name='mentor_edit_template'),
    ...
    # 커리큘럼 API
    path('api/clone_curriculum/<int:curriculum_id>/', views.clone_curriculum, name='clone_curriculum'),
    path('api/delete_curriculum/<int:curriculum_id>/', views.delete_curriculum, name='delete_curriculum'),
    # AJAX 멘티 목록
