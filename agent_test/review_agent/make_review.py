...
main_task = (
    ...
    "D+4",
    "자료형, 조건문, 반복문, 함수 등을 중심으로 파이썬의 핵심 개념을 실습 위주로 학습했습니다."
    "2025-07-19",  # plan_end_date
    "2025-07-23"   # real_end_date
)

cursor.execute("""
INSERT INTO tasks (title, guide, date, content, plan_end_date, real_end_date)
VALUES (?, ?, ?, ?, ?, ?)
""", main_task)
...
subtasks = [
    (
        ...
        이렇게 수정하였습니다.
        """,
        "2025-07-18",  # ✅ plan_end_date
        "2025-07-17"   # ✅ real_end_date
    ),
    (
        "조건문과 반복문 연습",
...
cursor.executemany("""
INSERT INTO subtasks (title, guide, date, content, plan_end_date, real_end_date, task_id)
VALUES (?, ?, ?, ?, ?, ?, ?)
